...
<!--                <li><a href="view_orders.php">Your Orders</a></li>-->
    ...
    <main>
        ...
        <section>
            <h2>Settings</h2>
            <p>If you need to change your account information, you can <a href="customer_manager?controllerRequest=edit_account">Edit Account</a>
 or <a href="change_password.php">change your password</a>.</p>
        </section>
    </main>
</body>
</html>
